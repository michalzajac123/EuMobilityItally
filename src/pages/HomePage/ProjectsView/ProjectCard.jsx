    ...
    <div className="shadow-md hover:shadow-xl rounded-xl overflow-hidden bg-white transition-all duration-300 hover:-translate-y-2 max-w-sm">
      ...
      <div className="text-container p-5">
        ...
        <button
          ...
          className="rounded-lg cursor-pointer uppercase font-semibold bg-[#20b486] hover:bg-[#1a9670] text-white w-full px-4 py-3 transition-colors duration-300 shadow-sm hover:shadow-md"
        >
          Read More
        </button>
      </div>
